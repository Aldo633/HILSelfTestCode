...
class NiDmmStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Control4022 = channel.unary_unary(
                '/nidmm_grpc.NiDmm/Control4022',
                request_serializer=nidmm__pb2.Control4022Request.SerializeToString,
                response_deserializer=nidmm__pb2.Control4022Response.FromString,
                )
...
def add_NiDmmServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Control4022': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=nidmm__pb2.Control4022Request.FromString,
                    response_serializer=nidmm__pb2.Control4022Response.SerializeToString,
            ),
...
class NiDmm(object):
    ...
    def Control4022(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/nidmm_grpc.NiDmm/Control4022',
            nidmm__pb2.Control4022Request.SerializeToString,
            nidmm__pb2.Control4022Response.FromString,
